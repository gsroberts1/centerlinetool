...
global flowPerHeartCycle_vol branchList flowPulsatile_vol res plot_flowWaveform
...
txt = {['Flow: ',sprintf('%0.3f',value),  ' mL/cycle ', sprintf('\n'), ...
    'Average: ',sprintf('%0.3f',mean(average)), ' mL/cycle']};
