...
f1=axes(handles.mipx);
f2=axes(handles.mipy);
f3=axes(handles.mipz);
figure(3); set(gcf,'Units','normalized');
set(gcf,'position',[0.35 0.1 0.25 0.25]);
...
figure(1); set(gcf,'Units','normalized');
set(gcf,'position',[0.5 0.1 0.25 0.25]);
...
set(gcf,'position',[0.35 .4 0.25 0.25]);
