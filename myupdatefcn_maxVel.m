...
count = 2;
global maxVel_vol branchList flowPulsatile_vol res plot_flowWaveform
...
txt = {['Max Velocity: ',sprintf('%0.3f',value),  ' cm/s ', sprintf('\n'), ...
    'Average: ',sprintf('%0.3f',mean(average)), ' cm/s']};
